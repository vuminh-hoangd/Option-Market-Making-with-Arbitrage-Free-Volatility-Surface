...
where $V_T$ is the market maker's total portfolio value at the close, $Q_t$ is the market maker's option inventory at time $t$: how many lots of the option they're currently holding for all $t\in [0,T] and \alpha and \beta are two penalty parameters that controls the risk level at the end of a trading period,
